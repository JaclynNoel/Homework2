...
```{r}
knitr::include_graphics("titi monkey.jpeg")
```

*Easier to include image if the image is in the folder with the other coding stuff!*
...
```{r}
hist(simulated_calls, breaks = 30, col = "lightblue", border = "black",
